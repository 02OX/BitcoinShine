...
UniValue signrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.params.size() > 3 && !request.params[3].isNull()) {
        static std::map<std::string, int> mapSigHashValues = {
           ...
           {std::string("ALL|BTCS_FORK"), int(SIGHASH_ALL|SIGHASH_BTCS_FORK)},
           {std::string("ALL|BTCS_FORK|ANYONECANPAY"), int(SIGHASH_ALL|SIGHASH_BTCS_FORK|SIGHASH_ANYONECANPAY)},
           {std::string("NONE"), int(SIGHASH_NONE)},
           {std::string("NONE|ANYONECANPAY"), int(SIGHASH_NONE|SIGHASH_ANYONECANPAY)},
           {std::string("NONE|BTCS_FORK"), int(SIGHASH_NONE|SIGHASH_BTCS_FORK)},
           {std::string("NONE|BTCS_FORK|ANYONECANPAY"), int(SIGHASH_NONE|SIGHASH_BTCS_FORK|SIGHASH_ANYONECANPAY)},
           {std::string("SINGLE"), int(SIGHASH_SINGLE)},
           {std::string("SINGLE|ANYONECANPAY"), int(SIGHASH_SINGLE|SIGHASH_ANYONECANPAY)},
           {std::string("SINGLE|BTCS_FORK"), int(SIGHASH_SINGLE|SIGHASH_BTCS_FORK)},
           {std::string("SINGLE|BTCS_FORK|ANYONECANPAY"), int(SIGHASH_SINGLE|SIGHASH_BTCS_FORK|SIGHASH_ANYONECANPAY)},
        };
